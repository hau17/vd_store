 ...
 * @author congh
 */
public class WarrantyGUI extends javax.swing.JFrame {

    /**
     * Creates new form WarrantyGUI
     */
    public WarrantyGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarrantyGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarrantyGUI().setVisible(true);
            }
        });
    }
